pipeline {
  agent any
  environment {
    PIPELINE_USER_CREDENTIAL_ID = 'AKIATQG2ZJYEDAZF3DKDRzyJhTe048LjeFOZUycG3tddBs8d8zjt/vhC0uHg'
    SAM_TEMPLATE = 'template.yaml'
    MAIN_BRANCH = 'main'
    TESTING_STACK_NAME = 'dev'
    TESTING_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-dev-pipe-PipelineExecutionRole-1UMWB9JA6IQDB'
    TESTING_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-dev-p-CloudFormationExecutionR-7QR13BXXAVH0'
    TESTING_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-dev-pipeline-artifactsbucket-i5f81jlagtqg'
    ...
    PROD_PIPELINE_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-prod-pip-PipelineExecutionRole-6RNK9QF5P4P7'
    PROD_CLOUDFORMATION_EXECUTION_ROLE = 'arn:aws:iam::240977006088:role/aws-sam-cli-managed-prod-CloudFormationExecutionR-T773V87C7S8N'
    PROD_ARTIFACTS_BUCKET = 'aws-sam-cli-managed-prod-pipeline-artifactsbucket-eqa7ck1yzdg'
    // If there are functions with "Image" PackageType in your template,
